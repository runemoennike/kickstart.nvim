return {
  ...
  config = function()
    ...
    local servers = {
      ...
      mason = {
        ...
        elixirls = {
          ...
          handlers = {
            ['textDocument/publishDiagnostics'] = elixirls_publish_diagnostics,
          },
        },
        azure_pipelines_ls = {},
        tombi = {},
    ...
    -- Fix for new tools not installing when nvim-lspconfig is loaded on VeryLazy
    ...
    require('mason-lspconfig').setup {
      ...
      -- rust_analyzer is managed by rustaceanvim (see custom/plugins/rustaceanvim.lua),
      -- so exclude it here to avoid a duplicate/conflicting LSP client.
